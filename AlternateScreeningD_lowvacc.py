#Implementing Alternate Screening Pathway (ASP) A: Normal NHS until 2025. Starting 2025, vaccinated women have a 10year/10year callback (rather than 5 year/3year)
...
if __name__=="__main__":
    ...
    for pars in parss:
        ...
        run_name = f"results/lowvacc/AlternateScreeningD/DResults_seed{seeds[seed_number]}_basepars{base_parss_number}"
