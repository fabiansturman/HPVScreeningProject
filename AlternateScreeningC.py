#Implementing Alternate Screening Pathway (ASP) C: Normal NHS until 2025. Starting 2025, if a vaccinated woman has a normal cytology, she is returned immediately to regular HPV testing pool (i.e. no consecutive HPV tests)
...
if __name__=="__main__":
    ...
    for pars in parss:
        ...
        run_name = f"results/AlternateScreeningC/CResults_seed{seeds[seed_number]}_basepars{base_parss_number}"
