...
#This rig has no vaccination drive, but runs the same screening pathway, and serves as one of two baselines (so then all vacc+less intervention options need to at least do as well as novacc+standardInterventions)
...
if __name__=="__main__":
    ...
    for pars in parss:
        ...
        run_name = f"results/NHSPathwayResultsNOVACC/NHSPathwayResultsNOVACC_seed{seeds[seed_number]}_basepars{base_parss_number}"
        ...
        algo = hpv.Sim(pars, interventions = [
