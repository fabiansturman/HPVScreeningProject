...
l=3
m=4
alg_name = "15_20_HV" #need alg name to save results from simulation runs to the correct pickle file

base_pars = copy.deepcopy(base_pars)
base_pars['interventions'] =  NHS_2025_lambdamu.get_interventions(l=l, m=m) + NHS_Vacc.vaccinations
