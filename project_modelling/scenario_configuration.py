...
screening_algorithm_stub_name = 'V7U5A5' #set the name we will be using for screening algorithms
screening_algorithm = screeningAlgorithms.get_interventions(v=7,u=5,a=5)
"""                                                         ^
