...
screening_algorithm_stub_name = 'V_U15A5' #set the name we will be using for screening algorithms
screening_algorithm = screeningAlgorithms.get_interventions(v=0,u=15,a=5)
"""                                                         ^
