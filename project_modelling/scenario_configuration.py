...
screening_algorithm_stub_name = 'V15U7A5' #set the name we will be using for screening algorithms
screening_algorithm = screeningAlgorithms.get_interventions(v=15,u=7,a=5)
"""                                                         ^
