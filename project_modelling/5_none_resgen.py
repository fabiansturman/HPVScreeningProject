...
l=1
m=None
alg_name = "5_none_HV" #need alg name to save results from simulation runs to the correct pickle file

base_pars = copy.deepcopy(base_pars)
base_pars['interventions'] = NHS_2025_lambdamu.get_interventions(l, m, end_vacc_screening_only_at_switch_year=True) + NHS_Vacc.vaccinations
