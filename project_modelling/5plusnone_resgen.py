...
l=1
m=None
alg_name = "5plusnone_HV" #need alg name to save results from simulation runs to the correct pickle file

base_pars = copy.deepcopy(base_pars)
base_pars['interventions'] =  NHS_2025_lambdamuForVaccCohortsOnly.get_interventions(l=l, m=m, end_younger_screening_at_switch_year=True) + NHS_Vacc.vaccinations
