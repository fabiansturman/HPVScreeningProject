...
plt.hlines(90, 0,10, colors='green', linestyles = 'dashed', label='NHS Target Vaccination Level: 90%')
plt.hlines(80, 0,10, colors='black', linestyles = 'dashed', label='Middle Vaccination Scenario 80%')

plt.hlines(60, 0, 10, colors='red', linestyles = 'dashed', label='Low Vaccination Scenario: 60% ')
...
boxplot = ax.bar([5,6,7,8,9, ],
                     [88.5, 83.2, 76.7, 74.1, 72.9 ],
                     width = 0.3, 
                     align='edge',
                     color=colours[0],
                     alpha=alpha,
...
boxplot = ax.bar([ 5.4, 6.4, 7.4, 8.4, 9.4],
                     [81.5, 78.6, 71.2, 68.5, 67.7 ],
                     width = 0.3, 
                     align='edge',
                     color=colours[1],
                     alpha=alpha,
...
plt.xticks([0.35,1.35,2.35,3.35,4.35,5.35,6.35,7.35,8.35,9.35], ['2014', '2015', '2016','2017', '2018', '2019', '2020', '2021', '2022','2023'])
...
for i in range(5):
    if i==0:
        ...
        plt.text(5.07+i, d[i]+1, round_str_to_str(str(d[i])))
    else:
