...
l=None
m=None
alg_name = "none_none_HV" #need alg name to save results from simulation runs to the correct pickle file

base_pars = copy.deepcopy(base_pars)
base_pars['interventions'] =  NHS_2025_lambdamu.get_interventions(l=l, m=m, end_all_screening_at_switch_year=True) + NHS_Vacc.vaccinations
