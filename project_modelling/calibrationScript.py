...
if __name__=="__main__":
    ...
    name =  f"project_modelling/calibration_results/Apr12_4_{calibration_code}" # "calibration_results/Feb14_1" #"calibration_results/Feb13_1"
    ...
    calib = hpv.Calibration(
        ...
        total_trials=5000,
        n_workers=10, #to be changed according to the multiprocessing capability of the hardware being used
